...
export class AddSessionAndContentInCourse1751640558735 implements MigrationInterface {
    name = 'AddSessionAndContentInCourse1751640558735'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "course_content" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "uploadUrl" character varying, "duration" integer, "isRead" boolean, "type" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "courseSessionId" integer, CONSTRAINT "PK_b5408ca87e293be3f489c1c5c81" PRIMARY KEY ("id"))`);
